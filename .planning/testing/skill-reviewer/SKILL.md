...
**Record results:** Use `references/review_report_template.md` and store the report in
...
Store reports in `.planning/testing/skill-reviewer/reviews/` using
...
Record review notes in `.planning/testing/skill-reviewer/reviews/` before PR creation.
```
...
- `references/review_report_template.md` - review output template
