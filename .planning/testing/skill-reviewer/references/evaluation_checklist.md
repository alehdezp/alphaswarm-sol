...
```
BAD: "Browse YouTube videos..."
BAD: "You can use this to..."
BAD: "I can help you..."
GOOD: "Browses YouTube videos..."
GOOD: "This skill processes..."
```
...
```
BAD: "Processes PDFs"
GOOD: "Extracts text and tables from PDF files. Use when working with PDF files or when the user mentions PDFs, forms, or document extraction."
```
...
```
BAD: "You should run the script..."
BAD: "The user can configure..."
GOOD: "Run the script..."
GOOD: "Configure by editing..."
```
