...
.. deprecated:: 2.0.0
    This module file is deprecated. The modular builder package
    at `alphaswarm_sol.kg.builder/` now takes precedence. This file is
    only preserved for backwards compatibility with direct file imports.

    Use `from alphaswarm_sol.kg.builder import VKGBuilder` instead.
"""
...
# Emit deprecation warning on direct file import
warnings.warn(
